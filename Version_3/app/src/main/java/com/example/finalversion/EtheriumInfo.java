...
public class EtheriumInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_etheriuminfo);


            ActionBar actionBar = getSupportActionBar();
            actionBar.setTitle("Ethereum");
                ...
                public void onResponse(Call call, Response response) throws IOException{
                    if (response.isSuccessful()){
                        ...
                        try{
                            ...
                            price = jsonResponse.getJSONObject("ethereum").getString("usd");
                        } catch (JSONException e){
                            e.printStackTrace();
                        }

                        String Prices = price;
                        EtheriumInfo.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
