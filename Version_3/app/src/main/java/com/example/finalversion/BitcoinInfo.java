...
public class BitcoinInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bitcoininfo);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Bitcoin");
            ...
            public void onResponse(Call call, Response response) throws IOException{
                if (response.isSuccessful()){
                    ...
                    try{
                        ...
                        price = jsonResponse.getJSONObject("bitcoin").getString("usd");
                    } catch (JSONException e){
                        e.printStackTrace();
                    }

                    String Prices = price;
                    BitcoinInfo.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
